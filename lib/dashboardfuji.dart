...
class MyHomePage extends StatelessWidget {
  List<productdata> _produklist = [
    ...
    productdata(
      ...
      price: 48.00,
      img: 'images/InstaxMiniCoral.png',
    ...
    productdata(
      ...
      price: 48.00,
      img: 'images/InstaxMiniLavender.png',
              ...
              subtitle: Column(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, '/detailfuji');
                    },
                    child: Text(
                      'Buy',
                      style: TextStyle(
